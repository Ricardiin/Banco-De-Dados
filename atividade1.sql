...
from estudantes
where profissao = 'Engenheiro' and sexo like 'M';
...
from estudantes
where nome like '%Silva' and sexo like 'M' ;
...
/* 8 */
select peso,sexo,count(*)
from estudantes
group by peso;

/*9 */
SELECT nome, altura, sexo, nacionalidade
FROM estudantes
WHERE sexo = 'F'
  AND altura > 1.60
...
select sexo,count(*)
from estudantes
where altura > '1.60' and sexo like 'F';
